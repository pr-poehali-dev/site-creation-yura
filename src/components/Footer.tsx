    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Мы создаем инновационные решения для бизнеса и помогаем нашим клиентам 
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#" className="hover:text-white transition-colors">Разработка сайтов</a>
              </li>
              <li>
                <a href="#" className="hover:text-white transition-colors">Мобильные приложения</a>
              </li>
              <li>
                <a href="#" className="hover:text-white transition-colors">Дизайн интерфейсов</a>
              </li>
              <li>
                <a href="#" className="hover:text-white transition-colors">Консультации</a>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-10 pt-6 text-center text-gray-400">
          <p>© 2024 БрендНейм. Все права защищены.</p>
        </div>
      </div>
    </footer>
  );
